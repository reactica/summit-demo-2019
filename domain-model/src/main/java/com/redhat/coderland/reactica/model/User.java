...
public class User {
  ...
  public boolean equals(Object o) {
    ...
    User user = (User) o;
    return getEnterQueueTime() == user.getEnterQueueTime() &&
            getCompletedRideTime() == user.getCompletedRideTime() &&
            getId().equals(user.getId()) &&
            getName().equals(user.getName()) &&
            getRideId().equals(user.getRideId()) &&
            getCurrentState().equals(user.getCurrentState());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getId(), getName(), getRideId(), getCurrentState(), getEnterQueueTime(), getCompletedRideTime());
  }
